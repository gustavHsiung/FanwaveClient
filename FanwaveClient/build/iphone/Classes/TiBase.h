...
// in simulator we redefine to format for FanwaveClient Developer console
...
{\
	NSString * exceptionName = [@"org.fanwaveclient." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fanwaveclient";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFanwaveClientNativeItemNone = -1, 
	UIFanwaveClientNativeItemSpinner = -2,
	UIFanwaveClientNativeItemProgressBar = -3,
	
	UIFanwaveClientNativeItemSlider = -4,
	UIFanwaveClientNativeItemSwitch = -5,
	UIFanwaveClientNativeItemMultiButton = -6,
	UIFanwaveClientNativeItemSegmented = -7,
	
	UIFanwaveClientNativeItemTextView = -8,
	UIFanwaveClientNativeItemTextField = -9,
	UIFanwaveClientNativeItemSearchBar = -10,
	
	UIFanwaveClientNativeItemPicker = -11,
	UIFanwaveClientNativeItemDatePicker = -12,
	
	UIFanwaveClientNativeItemInfoLight = -13,
	UIFanwaveClientNativeItemInfoDark = -14,
	
	UIFanwaveClientNativeItemDisclosure = -15,
	
	UIFanwaveClientNativeItemContactAdd = -16
};
